...
export default function Hero() {
  ...
  const items = [
    { title: "AI Image Generator", icon: ImageIcon, href: "#image" },
    { title: "AI Video Generator", icon: Video, href: "#video" },
    { title: "Erotic Chat", icon: MessageCircle, href: "#chat" },
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((it) => (
            <a
              ...
              onClick={() => { console.log("Hero tile click", it.title); }}
            >
