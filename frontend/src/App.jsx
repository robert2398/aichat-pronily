...
// Lazy-load heavy/rarely-used route components to shrink initial bundle
const Hero = lazy(() => import('./components/Hero'));
const AiPornIndex = lazy(() => import('./components/ai/AiPornIndex'));
const AiPornImage = lazy(() => import('./components/ai/AiPornImage'));
const AiPornVideo = lazy(() => import('./components/ai/AiPornVideo'));
const AiChat = lazy(() => import('./components/AiChat'));
const MyAI = lazy(() => import('./components/MyAI'));
const CreateCharacter = lazy(() => import('./components/CreateCharacter'));
const CreateCharacterSave = lazy(() => import('./components/CreateCharacterSave'));
const Gallery = lazy(() => import('./components/ai/Gallery'));
const SelectCharacter = lazy(() => import('./components/ai/SelectCharacter'));
const SelectBackground = lazy(() => import('./components/ai/SelectBackground'));
const SelectPose = lazy(() => import('./components/ai/SelectPose'));
const SelectOutfit = lazy(() => import('./components/ai/SelectOutfit'));
const SelectCharacterImage = lazy(() => import('./components/ai/SelectCharacterImage'));
const SelectCharacterVideo = lazy(() => import('./components/ai/SelectCharacterVideo'));
const SignIn = lazy(() => import('./components/auth/SignIn'));
const SignUp = lazy(() => import('./components/auth/SignUp'));
const SignUpCompact = lazy(() => import('./components/auth/SignUpCompact'));
      ...
      <Suspense fallback={<div className="py-12 text-center">Loading…</div>}>
        ...
        <Routes location={background || location}>
          ...
          <Route
            ...
            element={
              <main className="mx-auto max-w-5xl px-4 py-12">
                <Suspense fallback={<div>Loading…</div>}><AiPornIndex /></Suspense>
              </main>
            }
          />
          <Route
            ...
            element={
              <main className="mx-auto max-w-7xl px-4 py-12">
                <Suspense fallback={<div>Loading chat…</div>}><AiChat /></Suspense>
              </main>
            }
          />
          <Route
            ...
            element={
              <main className="mx-auto max-w-7xl px-4 py-12">
                <Suspense fallback={<div>Loading…</div>}><MyAI /></Suspense>
              </main>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <main className="mx-auto max-w-7xl px-4 py-12">
                <Suspense fallback={<div>Loading…</div>}><CreateCharacter /></Suspense>
              </main>
            }
          />
          <Route
            ...
            element={
              <main className="mx-auto max-w-7xl px-4 py-12">
                <Suspense fallback={<div>Loading…</div>}><CreateCharacterSave /></Suspense>
              </main>
            }
          />
          <Route
            ...
            element={
              <main className="mx-auto max-w-5xl px-4 py-12">
                <Suspense fallback={<div>Loading…</div>}><AiPornImage /></Suspense>
              </main>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <main className="mx-auto max-w-5xl px-4 py-12">
                <Suspense fallback={<div>Loading…</div>}><AiPornVideo /></Suspense>
              </main>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <main className="mx-auto max-w-7xl px-4 py-12">
                <Suspense fallback={<div>Loading gallery…</div>}><Gallery /></Suspense>
              </main>
            }
          />
          <Route
        ...
        {background && (
          <Routes>
            ...
            <Route path="/signup-compact" element={<AuthLayout><SignUpCompact /></AuthLayout>} />
